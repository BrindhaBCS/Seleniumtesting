...
def spam_patch_version_select(session, comp_id, search_comp, search_patch):
...
def main():
    ...
    #select_from_list_by_label(session, 6, comp_id,"SAPK-70001INBNWVS")
    spam_patch_version_select(session, comp_id, search_comp, search_patch)
